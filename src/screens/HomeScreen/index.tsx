  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onCancel}>
      <View style={modalStyles.backdrop}>
        <View style={[modalStyles.card, { borderColor: tokens.border }]}>
          <BlurView intensity={80} tint={tokens.tint} style={modalStyles.blurTop}>
            <BlurView
              intensity={40}
              tint={tokens.tint}
              style={[
            ...
            <Text style={[modalStyles.title, { color: colors.label }]}>
              {isFavorite ? 'Remove from Favorites?' : 'Add to Favorites?'}
            </Text>
            <Text style={[modalStyles.body, { color: colors.label }]}>
              {isFavorite
          ...
          <View style={[modalStyles.divider, { backgroundColor: colors.separator }]} />

          <BlurView intensity={80} tint={tokens.tint} style={modalStyles.actions}>
            <TouchableOpacity style={modalStyles.action} onPress={onCancel} activeOpacity={0.7}>
              <Text style={[modalStyles.actionLabel, { color: colors.tertiaryLabel }]}>Cancel</Text>
            </TouchableOpacity>
            <View style={[modalStyles.actionDivider, { backgroundColor: colors.separator }]} />
            <TouchableOpacity
    ...
    >
      ...
      >
        <BlurView
          intensity={60}
          tint="dark"
          style={[S.heartBlur, { borderColor: 'rgba(255,255,255,0.20)' }]}
        >
          <Ionicons
...
const EmptyState: React.FC<{ scheme: ColorScheme; isFavorites?: boolean }> = ({
  scheme,
  isFavorites,
}) => {
  const tokens = glassTokens[scheme];
    ...
    <View style={S.emptyContainer}>
      ...
      >
        <View style={S.emptyIconBlur}>
          <Ionicons
            name={isFavorites ? 'heart-outline' : 'map-outline'}
            size={64}
  ...
  return (
    <View style={[S.container, { backgroundColor: colors.systemBackground }]}>
      ...
      <ConfirmFavoriteModal
        ...
        onConfirm={() => {
          if (favoriteTarget) onToggleFavorite(favoriteTarget.id);
